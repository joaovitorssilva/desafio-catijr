          ...
          <div className="bg-[#18181B]/60 backdrop-blur-sm border border-white/5 rounded-3xl p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full bg- hover:bg-emerald-900/80 backdrop-blur-md border border-emerald-600/30 text-white py-3 rounded-xl font-semibold transition-all duration-200 cursor-pointer hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-800/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 hover:border-none"
              >
            ...
            <p className="text-center mt-8 text-gray-400">
              Já tem uma conta?{" "}
              <Link to="/login" className="text-emerald-500 hover:text-emerald-400 font-medium transition-colors duration-200">
                Entrar
              </Link>
            </p>
          </div>
